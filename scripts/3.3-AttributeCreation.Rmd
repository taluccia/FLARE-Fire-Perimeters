...
## Fire perimeters
```{r}
fires = st_read("../data/3.2-AdvanceClean/nbuf_equalarea_2020.shp", "nbuf_equalarea_2020") 
```
...
# Write to shapefile
```{r}
st_write(data11, "../outputs/3.3-Attribute/SiberiaFires_v2_2020.shp", driver="ESRI Shapefile") 
```
