...
9. South Siberian forest steppe (SSFT) (will delete at the end)
```{r}
...
# Create Polygon for Arctic

```{r}
eco_wgs_crop = ne_subset %>% st_crop(y = st_bbox(c(xmin = -180, ymin = 66.45, xmax = 180, ymax = 90))) 
```
...
```{r eval=FALSE, include=FALSE}
st_write(arctic_eco_bounds, "../outputs/ecozones/ecozone_arctic_crop_ee.shp", driver="ESRI Shapefile") 
