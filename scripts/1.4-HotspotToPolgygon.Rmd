...
# Overview
Convert Hotspot point data from MODIS to polygons. The purpose of this is to limit the extent of the vector function in GEE to delineate fire perimeters. This script utilizes data process in script 1.3. The script runs a single year at a time. Use find replace to change year and then run to process next year. Special code for 2003, 2019,and 2020, due to large data set and computational limits. 
...
2. Everything process to Russia Equal Area Projection
3. 2003, 2019 & 2020 are processed separately across 3 ROIs because of computational limits. 
...
# Data
##  Hotspot Data (MODIS)
**Change year on data with find and replace**
...
3. Union to merge overlapping polygons
