...
MODIS data is available 2001-present and was use instead of VIIRS, which launched October 2011 and has fire season data available 2012-present. Adding the data required more computing processing then avaialble.

The data is subset March to October to capture wildfire activity. The point data is eventially convert to polygons in script 1.3.
