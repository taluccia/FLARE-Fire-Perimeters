---
title: "Creat regions of interests"
author: "Anna Talucci"
date: "3/20/2021"
...
# Overview
The purpose of this script is to create three Regions of Interest across the eight ecozone study area. The ROIs are used to contain processing within computational limits. All outputs are in equal area projection for Russia.
...
While we will need the attribute field for the final fire perimeters, they are not necessary for the polygons we use in GEE as ROIs.
...
# Split ecozones into 3 ROI 
We split the the ecozones into three ROI (Regions of Interest) to process large data within the computational limits.

## First ROI Northeastern Ecozones 
```{r}
group1 = ecozone %>% 
...
## Second and Third ROI for Eastern Siberia Ecozones
```{r}
group2 = ecozone %>% 
